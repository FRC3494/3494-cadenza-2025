...
public class Drivetrain extends SubsystemBase {
  ...
  public Drivetrain() {
    ...
    // -Sean Borneman, 2025
    RobotConfig config = new RobotConfig(100, 10, new ModuleConfig(2,
        Constants.Drivetrain.MAX_VELOCITY_METERS_PER_SECOND,
        Math.hypot(Constants.Drivetrain.TRACKLENGTH_METERS / 2.0, Constants.Drivetrain.TRACKWIDTH_METERS / 2.0),
        new DCMotor(Constants.Drivetrain.TRACKLENGTH_METERS, Constants.Drivetrain.TRACKWIDTH_METERS,
            Constants.Drivetrain.MAX_VELOCITY_METERS_PER_SECOND,
            Constants.Drivetrain.MAX_VELOCITY_METERS_PER_SECOND / Math
                .hypot(Constants.Drivetrain.TRACKWIDTH_METERS / 2.0, Constants.Drivetrain.TRACKLENGTH_METERS / 2.0),
            Math.hypot(Constants.Drivetrain.TRACKWIDTH_METERS / 2.0, Constants.Drivetrain.TRACKLENGTH_METERS / 2.0), 0),
        1, 1), 0);
    try {
    ...
    AutoBuilder.configure(
        ...
        new PPHolonomicDriveController(new PIDConstants(5.0, 0.0, 0.0), // Translation PID constants
